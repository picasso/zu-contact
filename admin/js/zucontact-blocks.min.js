var zucontact_blocks = (function (exports) {
  ...
  var _lodash$3 = lodash,
      ...
      keys$1 = _lodash$3.keys; // , transform, map, cloneDeep
  ...
  var initialState = _defineProperty({}, formsKey, {});
  ...
  function formReducer() {
    ...
    function field(state, name, id) {
      return get$1(state, [formsKey, name, id], {});
    }

    function shallowClone(state) {
      var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      if (name) return set(state, [formsKey, name], _objectSpread2({}, get$1(state, [formsKey, name], {})));
      return set(state, [formsKey], _objectSpread2({}, get$1(state, [formsKey], {})));
    }
    ...
    switch (type) {
      ...
      case TYPES.REMOVE_FIELD:
        if (has$1(state, [formsKey, name])) state = shallowClone(state, name);
      ...
      case TYPES.UPDATE_FIELD:
        if (action.updated === 'type') {
          ...
          var newField = _objectSpread2({}, field(state, name, action.id));

          set(newField, action.updated, get$1(action.value, action.updated));
      ...
      case TYPES.RENAME_FORM:
        set(state, [formsKey, name], get$1(state, [formsKey, action.previousName]));
  ...
  var formActions = {
    updateForm: function updateForm(name, action, value) {
      var params = pick$1(value, ['id', 'previousId', 'previousName', 'updated', 'template']);
      return _objectSpread2({
        type: action,
        name: name,
        value: pick$1(value, ['id', 'type', 'required', 'requiredValue'])
      }, params);
    },
  ...
  var _wp$data$1 = wp.data,
      ...
      subscribe$1 = _wp$data$1.subscribe; // const { createHigherOrderComponent } = wp.compose;
  ...
  var useUpdateForm$1 = function useUpdateForm$1(formName) {
    ...
    var updateField = useCallback(function (action, value) {
      return updateForm(formName, action, value);
    }, [formName, updateForm]);
  ...
  var useOnFieldRemove = function useOnFieldRemove(id, updateField) {
    ...
    useEffect(function () {
      return function () {
        ...
        updateFieldSynced(TYPES.REMOVE_FIELD, {
          id: id
        });
      };
    }, []);
  ...
  var _lodash$5 = lodash,
      isNil$1 = _lodash$5.isNil; // const { compose } = wp.compose;
  ...
  var _wp$element$1 = wp.element,
      ...
      forwardRef = _wp$element$1.forwardRef; // Zukit dependencies
  ...
  var uniqueValue = wp.zukit.utils.uniqueValue;
  ...
  var ZuFormEdit = function ZuFormEdit(_ref) {
    ...
    var onChangeName = useCallback$3(function (value) {
      ...
      updateForm(value, TYPES.RENAME_FORM, {
        previousName: name
      });
    ...
    var setLayout = useCallback$3(function (layout) {
      ...
      updateForm(uniqueName, TYPES.CREATE_FORM, {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      ...
      onClick: function onClick() {
        return updateForm(postId, name, {
          name: name,
          title: title
        });
      }
    }, "Update Form")), /*#__PURE__*/React.createElement(PanelBody, {
  ...
  var ZuSubmitEdit = function ZuSubmitEdit(_ref) {
    ...
    }, permalinkLabel), /*#__PURE__*/React.createElement(Button$1, {
      isSecondary: true,
      href: previewLink,
      target: "zu-form-preview",
      rel: "external noreferrer noopener"
    }, __$6('Preview')), /*#__PURE__*/React.createElement(Button$1, {
      isPrimary: true,
      onClick: closeModal
    }, __$6('Close')))));
  };
  ...
  var ZuField = function ZuField(_ref, ref) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: mergeClasses$2(fieldPrefix, prefixIt('control'), {
  ...
  var uniqueValue$1 = wp.zukit.utils.uniqueValue;
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    ...
    useEffect$2(function () {
      if (isNil$5(id)) {
        ...
        var newAttrsWithId = _objectSpread2(_objectSpread2({}, newAttrs), {}, {
          id: uniqueValue$1(newAttrs.id, availableFieldIds, 'id')
        });

        setAttributes(newAttrsWithId);
        updateField(TYPES.ADD_FIELD, _objectSpread2(_objectSpread2({}, newAttrsWithId), {}, {
          requiredValue: requiredDefaults[newAttrsWithId.type]
        }));
      } else {
        // сомнительно что работает
        updateField(TYPES.ADD_FIELD, {
          id: id,
          type: type,
          required: required,
          requiredValue: requiredDefaults[type]
        });
      } // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    var onChangeRequired = useCallback$6(function () {
      ...
      updateField(TYPES.UPDATE_FIELD, {
        id: id,
        updated: 'required',
        required: !required
      });
    ...
    var onChangeId = useCallback$6(function (newId) {
      ...
      updateField(TYPES.RENAME_FIELD, {
        updated: 'id',
        previousId: id,
        id: newId
      });
    ...
    var _useState5 = useState$2(requiredDefaults[type] || null),
    ...
    var onSubmitRequired = useCallback$6(function () {
      ...
      updateField(TYPES.UPDATE_FIELD, {
        ...
        requiredValue: temporaryRequired
      });
    }, [id, temporaryRequired, updateField]); // Placeholder helpers ----------------------------------------------------]
    ...
    var selectType = useCallback$6(function (selected) {
      ...
      var newRequired = has$2(requiredRef.current, selected) ? requiredRef.current[selected] : requiredDefaults[selected]; // avoid duplicate field id
      ...
      updateField(TYPES.UPDATE_FIELD, _objectSpread2(_objectSpread2({
        updated: 'type',
        previousId: id
      }, newAttrsWithId), {}, {
