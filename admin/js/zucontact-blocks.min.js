var zucontact_blocks = (function (exports) {
  ...
  var assets = {
    ...
    svg: {
      ...
      contact: contact,
      booking: booking,
      //: { src: booking, foreground: iconColor },
      subscribe: subscribe //: { src: subscribe, foreground: iconColor },
  ...
  var _wp$zukit$utils$1 = wp.zukit.utils,
      ...
      toBool = _wp$zukit$utils$1.toBool; // Internal dependencies
  ...
  var ZuForm = function ZuForm(_ref) {
    ...
    }, title); // const postLink = isNil(postSlug) ? '' : `/${trim(postSlug, '/')}/`;
  ...
  var ZuPlainEdit = function ZuPlainEdit(_ref) {
    var attrKey = _ref.attrKey,
        value = _ref.value,
    ...
    var setText = useCallback(function (val) {
      ...
      setAttributes(_defineProperty({}, attrKey, doc.body.innerText));
  ...
  var metadata = {
    ...
    description: __$1('Add a contact form to your page.', 'zu-contact'),
    category: 'layout',
    keywords: [
  ...
  var _wp$element = wp.element,
      useCallback$2 = _wp$element.useCallback,
      useEffect = _wp$element.useEffect; // Internal dependencies
  ...
  var ZuFormEdit = function ZuFormEdit(_ref) {
    ...
    }, /*#__PURE__*/React.createElement(ZuPlainEdit, {
      value: title,
      attrKey: 'title',
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      ...
      template: layoutTemplates[name] // templateLock="all"
      ,
  ...
  var _lodash$6 = lodash,
      map$1 = _lodash$6.map,
      transform$2 = _lodash$6.transform,
      includes$1 = _lodash$6.includes,
      omit = _lodash$6.omit;
  var __$4 = wp.i18n.__; // 'text'+
  ...
  var typeOptions = [{
    value: 'text',
    label: __$4('Text Field', 'zu-contact')
  }, {
    value: 'textarea',
    label: __$4('Message Field', 'zu-contact')
  }, {
    value: 'email',
    label: __$4('E-mail Field', 'zu-contact')
  }, {
    value: 'tel',
    label: __$4('Phone Field', 'zu-contact')
  }, {
    value: 'url',
    label: __$4('URL Field', 'zu-contact')
  }, {
    value: 'checkbox',
    label: __$4('Checkbox Field', 'zu-contact')
  }, {
    value: 'number',
    label: __$4('Number Field', 'zu-contact')
  }, {
    value: 'submit',
    label: __$4('Submit Button Field', 'zu-contact')
  }];
  ...
  var _wp$element$1 = wp.element,
      ...
      useCallback$3 = _wp$element$1.useCallback,
  ...
  var ZuSubmitEdit = function ZuSubmitEdit(_ref) {
    ...
    var message = __$5('Sorry, but the form submission doesn\'t work in Edit mode.\n' + 'To test the form go to Preview mode.', 'zu-contact');
    ...
    return type !== 'submit' ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
      ...
      value: label,
      attrKey: 'label',
      placeholder: __$5('Add button label...', 'zu-contact'),
      setAttributes: setAttributes
    })), isOpen && /*#__PURE__*/React.createElement(Modal, {
      className: "zukit-modal",
      title: __$5('Warning', 'zu-contact'),
      closeLabel: __$5('Close'),
      ...
      rel: "external noreferrer noopener"
    }, __$5('Preview')), /*#__PURE__*/React.createElement(Button, {
      isPrimary: true,
      onClick: closeModal
    }, __$5('Close')))));
  };
  ...
  var ZuSubmitEdit$1 = compose$1([withSelect$1(function (select) {
    ...
    var label = [getCurrentPostType() === 'page' ? __$5('View Page') : __$5('View Post'), __$5('in new tab')].join(' ');
    return {
  ...
  var ZuField = function ZuField(_ref) {
    ...
    var idWithPrefix = prefixIt(id); // const isRequired =
    // const requiredData = {
    ...
    var control = type === 'textarea' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("textarea", {
      ...
      placeholder: placeholderValue,
      onChange: onChange // { ...requiredData }
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: mergeClasses$1(prefixIt('control'), {
        __submit: type === 'submit',
        success: true,
        error: validationEdit
      }, className)
    }, type === 'checkbox' ? null : controlLabel, /*#__PURE__*/React.createElement("div", {
      className: mergeClasses$1(prefixIt('input'), type)
  ...
  var _wp$components$3 = wp.components,
      ...
      Button$1 = _wp$components$3.Button;
  ...
  var ZuFieldBlockControls = function ZuFieldBlockControls(_ref) {
    ...
    var placeholderLabel = isEditingPlaceholder ? __$6('Finish editing', 'zu-contact') : placeholder$1 ? __$6('Edit placeholder', 'zu-contact') : __$6('Insert placeholder', 'zu-contact');
    ...
    var onRequiredClick = useCallback$4(function () {
      return isEditingRequired ? onCancelRequired() : onEditRequired();
    }, [isEditingRequired, onEditRequired, onCancelRequired]);
    var requiredLabel = isEditingRequired ? __$6('Finish editing', 'zu-contact') : placeholder$1 ? __$6('Edit error message for the required field', 'zu-contact') : __$6('Insert error message for the required field', 'zu-contact');
    return /*#__PURE__*/React.createElement(BlockControls, null, controls && /*#__PURE__*/React.createElement(ConditionalWrap, {
      wrap: Disabled,
      condition: isDisabled
    }, controls), /*#__PURE__*/React.createElement(ConditionalWrap, {
      wrap: Disabled,
      condition: isDisabled || isPlaceholderDisabled
    }, /*#__PURE__*/React.createElement(ToolbarGroup, null, /*#__PURE__*/React.createElement(Button$1, {
      icon: isEditingPlaceholder ? close : placeholder,
      className: "components-toolbar__control",
      label: placeholderLabel,
      "aria-expanded": isEditingPlaceholder,
      onClick: onPlaceholderClick // ref={ buttonRef }

    }))), /*#__PURE__*/React.createElement(ConditionalWrap, {
      wrap: Disabled,
      condition: isDisabled || isRequiredDisabled
    }, /*#__PURE__*/React.createElement(ToolbarGroup, null, /*#__PURE__*/React.createElement(Button$1, {
      icon: isEditingRequired ? close : required,
      className: "components-toolbar__control",
      label: requiredLabel,
      "aria-expanded": isEditingPlaceholder,
  ...
  var withSelect$2 = wp.data.withSelect; // , withDispatch

  var _wp$element$2 = wp.element,
      useState$1 = _wp$element$2.useState,
      useCallback$5 = _wp$element$2.useCallback,
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    ...
    var _useState3 = useState$1(false),
        ...
        isEditingPlaceholder = _useState4[0],
        setIsEditingPlaceholder = _useState4[1];

    var _useState5 = useState$1(false),
        _useState6 = _slicedToArray(_useState5, 2),
        isEditingRequired = _useState6[0],
        setIsEditingRequired = _useState6[1];

    var attrRef = useRef$1(null);
    var labelEdit = type === 'submit' ? null : /*#__PURE__*/React.createElement("label", null, /*#__PURE__*/React.createElement(ZuPlainEdit, {
      value: label,
      attrKey: 'label',
      placeholder: __$7('Add field label...', 'zu-contact'),
      setAttributes: setAttributes
    }), required && /*#__PURE__*/React.createElement("span", {
      className: "required"
    }, "*"));
    var validationEdit = !isEditingRequired || type === 'submit' ? null : /*#__PURE__*/React.createElement(ZuPlainEdit, {
      className: "__validation",
      value: "Please give your email address.",
      attrKey: 'label',
      placeholder: __$7('Add field error message...', 'zu-contact'),
      setAttributes: setAttributes
    });
    ...
    var placeholderEdit = !isEditingPlaceholder ? null : /*#__PURE__*/React.createElement("div", {
      ...
      value: placeholder,
      attrKey: 'placeholder',
      placeholder: __$7('Add field placeholder...', 'zu-contact'),
      setAttributes: setAttributes
    }));
    ...
    var selectType = useCallback$5(function (selected) {
      ...
      var newAttrs = has$1(attrRef.current, selected) ? attrRef.current[selected] : typeDefaults[selected]; // we should avoid duplicate field id
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls$1, null, /*#__PURE__*/React.createElement(PanelBody$1, {
      ...
      title: __$7('Field Settings', 'zu-contact')
    }, /*#__PURE__*/React.createElement(SelectItemControl$1, {
      isSmall: true,
      withTooltip: true,
      label: __$7('Field Type', 'zu-contact'),
      ...
      recap: {
        label: __$7('Current Field Type', 'zu-contact'),
        style: {
          color: iconColor
        }
      }
    }), type !== 'submit' && /*#__PURE__*/React.createElement(ToggleControl$1, {
      label: __$7('This is a required field.', 'zu-contact'),
      checked: !!required,
      onChange: function onChange() {
        return setAttributes({
          required: !required
      ...
      label: __$7('Field Id', 'zu-contact'),
      help: __$7('Usually you don\'t need to change it', 'zu-contact'),
      value: id,
      onChange: function onChange(val) {
        return setAttributes({
          id: uniqueId(val)
      ...
      onEditPlaceholder: function onEditPlaceholder() {
        return setIsEditingPlaceholder(true);
      },
      onCancelPlaceholder: function onCancelPlaceholder() {
        return setIsEditingPlaceholder(false);
      },
      isEditingRequired: isEditingRequired,
      onEditRequired: function onEditRequired() {
        return setIsEditingRequired(true);
      },
      onCancelRequired: function onCancelRequired() {
        return setIsEditingRequired(false);
      }
    }, {
      id: id,
      type: type,
      required: required,
      placeholder: placeholder
    })), /*#__PURE__*/React.createElement(ZuField, _extends({
      isEditor: true,
      labelEdit: labelEdit,
  ...
  var edit$1 = compose$2([withSelect$2(function (select, _ref2) {
    ...
    var availableFieldIds = map$2(fieldIds, function (id) {
      return get$2(getBlockAttributes(id), 'id', null);
    });
    ...
    return {
      uniqueId: uniqueId // availableFieldIds,
  ...
  // WordPress dependencies
  var __$8 = wp.i18n.__; // Internal dependencies
  var name$1 = 'zu/field';
  ...
  var metadata$1 = {
    ...
    /* translators: block description */
    description: __$8('A text box for longer responses.', 'zu-contact'),
    category: 'layout',
    keywords: [
    /* translators: block keyword */
    __$8('field', 'zu-contact'),
    /* translators: block keyword */
    __$8('feedback', 'zu-contact'),
    /* translators: block keyword */
    __$8('form', 'zu-contact')],
    icon: {
      src: field,
      foreground: iconColor
    },
