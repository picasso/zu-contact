var zucontact_blocks = (function (exports) {
  ...
  var ZuSubmitEdit = function ZuSubmitEdit(_ref) {
    ...
    var closeModal = useCallback$4(function () {
    ...
    var message = __$7('Sorry, but the form submission doesn\'t work in Edit mode.\n' + 'To test the form go to Preview mode.', 'zu-contact');
    ...
    return type !== 'submit' ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
      ...
      title: __$7('Warning', 'zu-contact'),
      closeLabel: __$7('Close'),
      ...
      rel: "external noreferrer noopener"
    }, __$7('Preview')), /*#__PURE__*/React.createElement(Button, {
      isPrimary: true,
      onClick: closeModal
    }, __$7('Close')))));
  };
  ...
  var _wp$components$5 = wp.components,
      Button$1 = _wp$components$5.Button,
      Icon$1 = _wp$components$5.Icon,
      Modal$1 = _wp$components$5.Modal;
  var _wp$element$5 = wp.element,
      useCallback$7 = _wp$element$5.useCallback,
      useState$3 = _wp$element$5.useState; // Internal dependencies

  var stubMessage = __$a('This is just a visual emulation of Google reCAPTCHA, it doesn\'t work in Edit mode.\n' + 'To test reCAPTCHA go to Preview mode.', 'zu-contact');
  ...
  var ZuRecaptchaStub = function ZuRecaptchaStub(_ref) {
    ...
    var closeModal = useCallback$7(function () {
      return setOpen(false);
    }, []);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    }, __$a('Terms', 'zu-contact'))))), isOpen && /*#__PURE__*/React.createElement(Modal$1, {
      className: "zukit-modal",
      title: __$a('Warning', 'zu-contact'),
      closeLabel: __$a('Close'),
      onRequestClose: closeModal
    }, /*#__PURE__*/React.createElement("div", {
      className: "__content-wrapper"
      ...
      className: "__gold __icon",
      icon: required
    }), /*#__PURE__*/React.createElement("div", null, stubMessage.split('\n').map(function (line, key) {
      return /*#__PURE__*/React.createElement("p", {
        key: key
      }, line);
    }))), /*#__PURE__*/React.createElement("div", {
  ...
  var _wp$components$6 = wp.components,
      PanelBody$2 = _wp$components$6.PanelBody,
      ToggleControl$2 = _wp$components$6.ToggleControl;
  ...
  var ZuRecaptchaEdit = function ZuRecaptchaEdit(_ref) {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls$2, null, /*#__PURE__*/React.createElement(PanelBody$2, {
      title: __$b('reCAPTCHA Settings', 'zu-contact')
