var zucontact_blocks = (function (exports) {
  ...
  var allowedBlocks = [fieldBlock]; // Create template object based on layout options
  // 'contact': [
  ...
  var ZuFormEdit = function ZuFormEdit(_ref) {
    ...
    var name = attributes.name,
        ...
        useRecaptcha = attributes.useRecaptcha; // Sync form changes with information stored on the server ----------------]
    // * * *
    ...
    var _useState5 = useState({
      ...
      isCompact: false
        ...
        recaptcha = _useState6[0],
        setRecaptcha = _useState6[1];

    var enableRecaptcha = useCallback$3(function (val) {
      setAttributes({
        useRecaptcha: val
      });
      setRecaptcha(function (value) {
        return _objectSpread2(_objectSpread2({}, value), {}, {
          enabled: val
        });
      });
    }, [setAttributes]); // <PanelBody title={ __('Plugin options', 'zu-contact') }>
    // 	<PluginOptionsEdit/>
    // </PanelBody>
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      ...
      label: __$3('Without Form Heading', 'zu-contact'),
      checked: withoutTitle,
      onChange: disableTitle
    }), /*#__PURE__*/React.createElement(ToggleControl, {
      label: __$3('Enable reCAPTCHA', 'zu-contact'),
      checked: useRecaptcha,
      onChange: enableRecaptcha
    }), /*#__PURE__*/React.createElement(ToggleControl, {
      label: __$3('Dark reCAPTCHA', 'zu-contact'),
      checked: recaptcha.isDark,
      onChange: function onChange(val) {
        return setRecaptcha(function (value) {
          return _objectSpread2(_objectSpread2({}, value), {}, {
            isDark: val
          });
        });
      ...
      label: __$3('Compact reCAPTCHA', 'zu-contact'),
      ...
      value: updateField
    }, /*#__PURE__*/React.createElement(RecaptchaContext.Provider, {
      value: recaptcha
  ...
  var metadata$1 = {
    ...
    /* translators: block description */
    description: __$4('Form field of various types and flexible settings.', 'zu-contact'),
    category: 'layout',
    keywords: [
    /* translators: block keyword */
  ...
  var ZuField = function ZuField(_ref, ref) {
    var labelEdit = _ref.labelEdit,
        ...
        recaptchaEdit = _ref.recaptchaEdit,
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, recaptchaEdit, /*#__PURE__*/React.createElement("div", {
  ...
  var _wp$components$4 = wp.components,
      Button$1 = _wp$components$4.Button,
      Icon$1 = _wp$components$4.Icon,
      Modal$1 = _wp$components$4.Modal;
  var _wp$element$4 = wp.element,
      useCallback$6 = _wp$element$4.useCallback,
      useState$2 = _wp$element$4.useState; // Internal dependencies

  var ZuRecaptcha = function ZuRecaptcha(_ref) {
    ...
    var closeModal = useCallback$6(function () {
      return setOpen(false);
    }, []);
    var recaptchaClick = useCallback$6(function (ev) {
      setOpen(true);
      ev.preventDefault();
    }, []);

    var message = __$8('This is just a visual emulation of Google reCAPTCHA, it doesn\'t work in Edit mode.\n' + 'To test reCAPTCHA go to Preview mode.', 'zu-contact');
    ...
    }, "\u042F \u043D\u0435 \u0440\u043E\u0431\u043E\u0442")))), /*#__PURE__*/React.createElement("div", {
    ...
    }, "\u041A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u044C"), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true"
    }, " - "), /*#__PURE__*/React.createElement("a", {
      href: "https://www.google.com/intl/ru/policies/terms/"
    }, "\u0423\u0441\u043B\u043E\u0432\u0438\u044F \u0438\u0441\u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u043D\u0438\u044F")))), isOpen && /*#__PURE__*/React.createElement(Modal$1, {
      className: "zukit-modal",
      title: __$8('Warning', 'zu-contact'),
      closeLabel: __$8('Close'),
      onRequestClose: closeModal
    }, /*#__PURE__*/React.createElement("div", {
      className: "__content-wrapper"
  ...
  var _wp$components$5 = wp.components,
      PanelBody$1 = _wp$components$5.PanelBody,
      ToggleControl$1 = _wp$components$5.ToggleControl;
  ...
  var _wp$data$2 = wp.data,
      withSelect$2 = _wp$data$2.withSelect,
  ...
  var _wp$element$5 = wp.element,
      ...
      useRef$3 = _wp$element$5.useRef,
      useEffect$2 = _wp$element$5.useEffect; // Zukit dependencies
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    ...
    var _useState = useState$3(type === 'checkbox' ? false : ''),
        _useState2 = _slicedToArray(_useState, 2),
    ...
    var onChangeRequired = useCallback$7(function () {
      setAttributes({
        required: !required
      });
      updateField({
    ...
    var onChangeId = useCallback$7(function (newId) {
      setAttributes({
        id: newId
      });
      updateField({
    ...
    var _useState5 = useState$3(getRequiredValue(type)),
        _useState6 = _slicedToArray(_useState5, 2),
    ...
    var onEditRequired = useCallback$7(function () {
    ...
    var onSubmitRequired = useCallback$7(function () {
    ...
    var _useState7 = useState$3(false),
    ...
    var onEditPlaceholder = useCallback$7(function () {
    ...
    }, [isEditingPlaceholder]); // Recaptcha helpers ------------------------------------------------------]

    var recaptcha = useRecaptchaContext();
    var recaptchaEdit = type !== 'submit' ? null : /*#__PURE__*/React.createElement(ZuRecaptcha, recaptcha); // Other helpers ----------------------------------------------------------]
    ...
    var selectType = useCallback$7(function (selected) {
  ...
  var edit$1 = compose$2([withSelect$2(function (select, _ref2) {
    ...
    return {
      ...
      insert: function insert() {
        return insertBlock(createBlock(name$2, {
          type: 'text'
