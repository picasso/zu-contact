var zucontact_blocks = (function (exports) {
  ...
  var _pluginDefaults$templ = pluginDefaults.templates,
      ...
      recaptcha = pluginDefaults.recaptcha; // Options & Values
  ...
  var edit = compose([withSelect(function (select, _ref2) {
    ...
    return {
      enableRe: function enableRe(val) {
        return val ? insertBlock(createBlock(name$1, _objectSpread2({}, recaptcha)), insertIndex, clientId, false) : removeBlock(reClientId, false);
      }
    };
  })])(ZuFormEdit);
  ...
  var recaptcha$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    settings: settings$2,
    name: name$1,
    title: title
  ...
  function registerBlocks() {
    [form$1, field$1, recaptcha$1].forEach(function (block) {
      if (!block) return;
      var name = block.name,
