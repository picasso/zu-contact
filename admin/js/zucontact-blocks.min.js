var zucontact_blocks = (function (exports) {
  ...
  var _lodash = lodash,
      isNil = _lodash.isNil; // Zukit dependencies

  var _wp$zukit$utils = wp.zukit.utils,
      externalData = _wp$zukit$utils.externalData,
      mergeClasses = _wp$zukit$utils.mergeClasses,
      isNum = _wp$zukit$utils.isNum,
      toBool = _wp$zukit$utils.toBool,
      toJSON = _wp$zukit$utils.toJSON,
      uniqueValue = _wp$zukit$utils.uniqueValue,
      getColor = _wp$zukit$utils.getColor,
      hexToRGBA = _wp$zukit$utils.hexToRGBA,
      brandAssets = _wp$zukit$utils.brandAssets,
      registerCollection = _wp$zukit$utils.registerCollection,
      registerCategory = _wp$zukit$utils.registerCategory; // Import debug object and make it available from global scope
  window.Zubug = _objectSpread2({}, wp.zukit.debug || {}); // Gets JSON data from PHP

  var pluginData = externalData('zucontact_blocks_data');
  var _pluginData$prefix = pluginData.prefix,
      cssPrefix = _pluginData$prefix === void 0 ? 'zuc' : _pluginData$prefix;
  ...
  var _lodash$1 = lodash,
      keys = _lodash$1.keys,
      has = _lodash$1.has,
      transform = _lodash$1.transform;
  var _wp$components = wp.components,
      Path = _wp$components.Path,
      G = _wp$components.G,
      SVG = _wp$components.SVG; // Internal dependencies
  ...
  var recaptcha = /*#__PURE__*/React.createElement(SVG, {
    width: "24",
    height: "24",
    viewBox: "0 0 24 24",
    xmlns: "http://www.w3.org/2000/svg"
  }, /*#__PURE__*/React.createElement(G, null, /*#__PURE__*/React.createElement(Path, {
    d: "M2,12 C2,12.144 2.004,12.287 2.01,12.429 L2.01,20.546 L4.254,18.302 C6.091,20.55 8.885,21.986 12.014,21.986 C15.27,21.986 18.164,20.431 19.993,18.024 L16.314,14.307 C15.954,14.974 15.442,15.546 14.825,15.979 C14.182,16.48 13.273,16.89 12.014,16.89 C11.862,16.89 11.745,16.872 11.658,16.839 C10.099,16.715 8.747,15.855 7.951,14.606 L10.555,12.002 C7.257,12.015 3.532,12.023 2,12.001",
    fill: hexToRGBA(iconColor, 0.25),
    id: "full"
  }), /*#__PURE__*/React.createElement(Path, {
    d: "M11.986,2 L3.44,2.01 L5.684,4.254 C3.436,6.091 2,8.885 2,12.014 C2,12.014 2,12.014 2,12.014 C2.133,12.066 3.328,10.891 4.016,10.891 C4.703,10.891 3.328,10.906 4.25,10.906 C4.317,10.906 7.096,12.083 7.096,12.014 C7.27,10.099 8.131,8.747 9.38,7.951 L11.984,10.555 C11.971,7.257 11.963,3.532 11.985,2 M2,12.014 L7.096,12.014 C7.096,12.014 4.125,10.188 4.125,10.188 C4.125,10.188 2,12.014 2,12.014 z",
    fill: hexToRGBA(iconColor, 0.5),
    id: "50"
  }), /*#__PURE__*/React.createElement(Path, {
    d: "M21.97,11.986 L21.96,3.44 L19.72,5.684 C17.886,3.436 15.097,2 11.973,2 C11.973,2 11.973,2 11.973,2 C11.921,2.133 13.094,3.328 13.094,4.016 C13.094,4.703 13.079,3.328 13.079,4.25 C13.079,4.317 11.904,7.096 11.973,7.096 C13.885,7.27 15.234,8.131 16.029,9.38 L13.43,11.984 C16.722,11.971 20.441,11.963 21.97,11.985 M11.973,2 L11.973,7.096 C11.973,7.096 13.796,4.125 13.796,4.125 C13.796,4.125 11.973,2 11.973,2 z",
    fill: iconColor,
    id: "100"
  }))); // Layout icons
  ...
  var _lodash$2 = lodash,
      defaults = _lodash$2.defaults; // Internal dependencies

  var pluginDefaults = defaults(pluginData, {
    prefix: 'zuc',
    templates: {},
    types: {},
    recaptcha: {},
  ...
  var name = 'zu/recaptcha';

  var title = __('reCAPTCHA');
  ...
  var layoutOptions = [{
    value: 'contact',
    label: __$1('Contact Layout', 'zu-contact'),
    layout: params('contact')
  }, {
    value: 'booking',
    label: __$1('Booking Layout', 'zu-contact'),
    layout: params('booking')
  }, {
    value: 'subscribe',
    label: __$1('Subscribe Layout', 'zu-contact'),
    layout: params('subscribe')
  }, {
    value: 'skip',
    label: __$1('Skip', 'zu-contact'),
    layout: params('default')
  }];
  var fieldBlock = 'zu/field';
  var allowedBlocks = [fieldBlock, name];
  // 'contact': [
  ...
  var _lodash$4 = lodash,
      isFunction = _lodash$4.isFunction,
      isPlainObject = _lodash$4.isPlainObject,
      isEmpty = _lodash$4.isEmpty,
      isEqual = _lodash$4.isEqual,
      isUndefined = _lodash$4.isUndefined,
      omitBy = _lodash$4.omitBy,
      has$1 = _lodash$4.has,
      get$1 = _lodash$4.get,
      set = _lodash$4.set,
      unset = _lodash$4.unset,
      pull = _lodash$4.pull,
      pick$1 = _lodash$4.pick,
      keys$1 = _lodash$4.keys,
      cloneDeep = _lodash$4.cloneDeep;
  ...
  var _wp = wp,
      apiFetch = _wp.apiFetch; // Zukit dependencies

  var _wp$zukit$data = wp.zukit.data,
      isNull = _wp$zukit$data.isNull,
      requestURL = _wp$zukit$data.requestURL; // Internal dependencies

  var ZUCONTACT_STORE = 'zucontact/form';
  var fetchKey = 'zucontact_forms';
  var formsKey = 'forms';
  var dirtyKey = 'dirty';
  ...
  var initialState = (_initialState = {}, _defineProperty(_initialState, formsKey, get$1(pluginDefaults, 'store', {})), _defineProperty(_initialState, dirtyKey, false), _initialState); // we need this to compare in Reducer if there are changes

  var initialForms = cloneDeep(initialState[formsKey]);

  var pickAttributes = function pickAttributes(value) {
    var picked = pick$1(value, ['id', 'type', 'required', 'requiredValue']);
  ...
  function formReducer() {
    ...
    function shallowClone(state) {
      var fieldPath = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      if (fieldPath) set(state, fieldPath, _objectSpread2({}, get$1(state, fieldPath, {})));
      set(state, [formsKey], _objectSpread2({}, get$1(state, [formsKey], {})));
    }
    ...
    var type = action.type,
        ...
        id = action.id,
        value = action.value;
    var fieldPath = [formsKey, name, fieldsKey, id];
    var formPath = [formsKey, name];
    var callback = isFunction(value) ? value : function () {
      return value;
    };
    ...
    var prevValue = get$1(state, id ? fieldPath : formPath, {});

    switch (type) {
      case TYPES.ADD_FIELD:
        {
          var newField = pickAttributes(callback(prevValue));
      ...
      case TYPES.REMOVE_FIELD:
        ...
        if (has$1(state, formPath)) shallowClone(state, fieldPath);
        unset(state, fieldPath);
        break;

      case TYPES.RENAME_FIELD:
        unset(state, fieldPath);
        set(state, [].concat(_toConsumableArray(pull(fieldPath, id)), [callback(id)]), prevValue);
        break;

      case TYPES.UPDATE_FIELD:
        if (updated === 'type') {
          var newValue = pickAttributes(callback(prevValue));
          unset(state, fieldPath);
          set(state, [].concat(_toConsumableArray(pull(fieldPath, id)), [newValue.id]), newValue);
        } else {
          var _newField = _objectSpread2(_objectSpread2({}, prevValue), {}, _defineProperty({}, updated, callback(prevValue[updated])));

          set(state, fieldPath, _newField);
        }
      ...
      case TYPES.RENAME_FORM:
        set(state, [].concat(_toConsumableArray(pull(formPath, name)), [callback(name)]), prevValue);
        unset(state, formPath);
        break;
    ...
    markDirty(state); // Zubug.data({ action, updated: get(state, id ? fieldPath : formPath), state });

    return state;
  }

  var formActions = {
    updateForm: function updateForm(name, action, value) {
      return _objectSpread2(_objectSpread2({}, isPlainObject(action) ? action : {
        type: action
      }), {}, {
        name: name,
    ...
    persistForms: /*#__PURE__*/regeneratorRuntime.mark(function persistForms(id, value) {
      var path, values, data, result;
      return regeneratorRuntime.wrap(function persistForms$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              path = requestURL('cuset');
              values = {
                id: id,
                value: value
              };
  ...
  registerStore(ZUCONTACT_STORE, {
    ...
    actions: formActions,
    selectors: {
      getDirtyForms: function getDirtyForms(state) {
        var dirty = get$1(state, dirtyKey, false);
        return dirty ? get$1(state, formsKey, emptyObject) : null;
      }
    },
    controls: {}
  }); // Custom hooks & helpers -----------------------------------------------------]

  var getUpdatedForms = function getUpdatedForms() {
    var _select = select(ZUCONTACT_STORE),
        getDirtyForms = _select.getDirtyForms;

    var forms = isFunction(getDirtyForms) ? getDirtyForms() : null;
    if (!isFunction(getDirtyForms)) Zubug.info('!getDirtyForms NOT Function');
    return forms;
  }; // Custom hook which set Forms data


  var useUpdateForm = function useUpdateForm() {
    var _useDispatch = useDispatch(ZUCONTACT_STORE),
        updateForm = _useDispatch.updateForm;

    return updateForm;
  };
  var persistForms = function persistForms() {
    var forms = getUpdatedForms();

    if (forms) {
      var _dispatch = dispatch(ZUCONTACT_STORE),
          persist = _dispatch.persistForms;
      ...
      if (postId && isFunction(persist)) {
        persist(postId, isEmpty(forms) ? null : forms); // Zubug.info('PERSIST', { postId, forms });
      }
    }
  };
  ...
  var _lodash$5 = lodash,
      set$1 = _lodash$5.set,
      unset$1 = _lodash$5.unset,
      values = _lodash$5.values;
  ...
  var _wp$data$1 = wp.data,
      ...
      subscribe$1 = _wp$data$1.subscribe; // Internal dependencies
  ...
  var useUpdateForm$1 = function useUpdateForm$1(fname) {
    var update = useUpdateForm();
    var updateForm = useCallback(function (name, action, value) {
      update(name, action, value);
    }, [update]);
    var updateField = useCallback(function (action, value) {
  ...
  var updateName = function updateName(clientId, name) {
    var remove = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    if (remove) unset$1(names, clientId);else set$1(names, clientId, name);
    forbiddenNames = values(names);
  };

  var getUsedNames = function getUsedNames() {
    return forbiddenNames;
  }; // Custom hook to notify on form removal (also collect form names)

  var useOnFormRemove = function useOnFormRemove(clientId, postId, name, updateForm) {
    var formRef = useRef({
      clientId: clientId,
      postId: postId,
      name: name,
    ...
    useEffect(function () {
      return function () {
        var _ref = formRef.current || {},
            clientId = _ref.clientId,
            name = _ref.name,
            updateForm = _ref.updateForm;

        updateForm(name, TYPES.PURGE_FORM); // delete form name from common list
  ...
  var useOnFieldRemove = function useOnFieldRemove(id, updateField) {
    var fieldRef = useRef({
      id: id,
    ...
    }, [id, updateField]); // 'updateField' will be called on field removing only

    useEffect(function () {
      return function () {
        // need to get 'updateField' again because it could be stuck in closure
        var _ref2 = fieldRef.current || {},
            id = _ref2.id,
            updateFieldSynced = _ref2.updateField;
  ...
  var ZuForm = function ZuForm(_ref) {
    ...
    var formNonce = withoutNonce ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("input", {
      type: "hidden",
      id: prefixIt('nonce'),
  ...
  var _wp$element$1 = wp.element,
      ...
      forwardRef = _wp$element$1.forwardRef; // Internal dependencies
  ...
  var ZuPlainEdit = function ZuPlainEdit(_ref, ref) {
    ...
    var setText = useCallback$1(function (val) {
      var doc = document.implementation.createHTMLDocument('');
      doc.body.innerHTML = val;
      setAttributes(isNil$1(attrKey) ? doc.body.innerText : _defineProperty({}, attrKey, doc.body.innerText));
  ...
  // WordPress dependencies
  var __$2 = wp.i18n.__; // Internal dependencies
  var name$1 = 'zu/form';
  /* translators: block name */

  var title$1 = __$2('Zu Form', 'zu-contact');
  ...
  var metadata$1 = {
    ...
    /* translators: block description */
    description: __$2('Simple but smart and modern Ajax contact form.', 'zu-contact'),
    category: 'layout',
    keywords: [
    /* translators: block keyword */
    __$2('contact', 'zu-contact'),
    /* translators: block keyword */
    __$2('feedback', 'zu-contact'),
    /* translators: block keyword */
    __$2('form', 'zu-contact')],
    icon: {
      src: form,
      foreground: iconColor
    },
    ...
    example: {
      attributes: {
        name: 'contact',
        title: __$2('Contact Us', 'zu-contact')
      }
    },
  ...
  var FormLayout = function FormLayout(_ref) {
    ...
    var selectLayout = useCallback$2(function (name) {
      setLayout(get$2(find(assets.layoutOptions, {
        value: name
      }), 'layout', {}));
    }, [setLayout]);
    ...
    return /*#__PURE__*/React.createElement(Placeholder, {
      ...
      ,
      label: ' ' + title$1,
      instructions: __$3('Select a form layout to start with.', 'zu-contact')
  ...
  var _wp$data$2 = wp.data,
      withSelect = _wp$data$2.withSelect,
      withDispatch = _wp$data$2.withDispatch;
  var _wp$element$2 = wp.element,
      useCallback$3 = _wp$element$2.useCallback,
      useEffect$1 = _wp$element$2.useEffect,
      useState = _wp$element$2.useState,
      useRef$1 = _wp$element$2.useRef; // Zukit dependencies
  ...
  var ZuFormEdit = function ZuFormEdit(_ref) {
    var clientId = _ref.clientId,
        ...
        setAttributes = _ref.setAttributes,
        reClientId = _ref.reClientId,
        enableRe = _ref.enableRe;
    var name = attributes.name,
        title = attributes.title,
        postId = attributes.postId,
        postLink = attributes.postLink,
        loader = attributes.loader; // Sync form changes with information stored on the server ----------------]
    // * * *
    ...
    var _useUpdateForm = useUpdateForm$1(name),
        _useUpdateForm2 = _slicedToArray(_useUpdateForm, 2),
        _useUpdateForm2$ = _useUpdateForm2[0],
        updateForm = _useUpdateForm2$ === void 0 ? noop : _useUpdateForm2$,
        updateField = _useUpdateForm2[1];
    ...
    var onChangeName = useCallback$3(function (value) {
      setAttributes({
        name: value
      });
    ...
    useEffect$1(function () {
      if (isNil$2(postId) || isNil$2(postLink)) {
        var link = isNil$2(editedPostSlug) ? '' : "/".concat(trim(editedPostSlug, '/'), "/");
        setAttributes({
    ...
    var _useState3 = useState(!title),
        ...
        withoutTitle = _useState4[0],
        setWithoutTitle = _useState4[1];

    var peviousTitle = useRef$1(title);
    var titleEdit = withoutTitle ? null : /*#__PURE__*/React.createElement("h2", {
      className: prefixIt('subheading')
    }, /*#__PURE__*/React.createElement(ZuPlainEdit$1, {
      value: title,
      attrKey: 'title',
      placeholder: __$4('Add form title...', 'zu-contact'),
      setAttributes: setAttributes
    }));
    var disableTitle = useCallback$3(function (val) {
      setAttributes({
        title: val ? '' : peviousTitle.current
      });
      if (val) peviousTitle.current = title;
      setWithoutTitle(val);
    }, [title, setAttributes]); // ReCAPTCHA --------------------------------------------------------------]

    var enableRecaptcha = useCallback$3(function (val) {
      setAttributes({
        useRecaptcha: val
      });
      enableRe(val);
    }, [setAttributes, enableRe]); // <PanelBody title={ __('Plugin options', 'zu-contact') }>
    // 	<PluginOptionsEdit/>
    // </PanelBody>
    // Layouts ----------------------------------------------------------------]

    var setLayout = useCallback$3(function (layout) {
      var uniqueName = uniqueValue(layout.name, getUsedNames());
    ...
    }, [updateForm, setAttributes]); // if the name is not defined - display the layout selection
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls, null, /*#__PURE__*/React.createElement(PanelBody, {
      title: __$4('Form Settings', 'zu-contact')
    }, /*#__PURE__*/React.createElement(ToggleControl, {
      label: __$4('Without Form Heading', 'zu-contact'),
      checked: withoutTitle,
      onChange: disableTitle
    }), /*#__PURE__*/React.createElement(ToggleControl, {
      label: __$4('Enable reCAPTCHA', 'zu-contact'),
      checked: reClientId || false,
      onChange: enableRecaptcha
    })), /*#__PURE__*/React.createElement(PanelBody, {
      title: __$4('Form Loader', 'zu-contact'),
      initialOpen: false
      ...
      loaders: loaders,
      setAttributes: setAttributes
    }))), /*#__PURE__*/React.createElement(InspectorAdvancedControls, null, /*#__PURE__*/React.createElement(AdvTextControl, {
      withDebounce: true,
      withoutClear: true,
      label: __$4('Form Name', 'zu-contact'),
      help: __$4('Usually you don\'t need to change it.', 'zu-contact'),
      value: name,
  ...
  var edit = compose([withSelect(function (select, _ref2) {
    ...
    return {
      enableRe: function enableRe(val) {
        return val ? insertBlock(createBlock(name, _objectSpread2({}, recaptcha$1)), insertIndex, clientId, false) : removeBlock(reClientId, false);
      }
    };
  })])(ZuFormEdit);
  ...
  var settings = _objectSpread2(_objectSpread2({}, metadata$1), {}, {
  ...
  // WordPress dependencies
  var __$5 = wp.i18n.__; // Internal dependencies
  var name$2 = 'zu/field';
  /* translators: block name */

  var title$2 = __$5('Zu Field', 'zu-contact');
  ...
  var metadata$2 = {
    ...
    /* translators: block description */
    description: __$5('Form field of various types with flexible settings.', 'zu-contact'),
    category: 'layout',
    keywords: [
    /* translators: block keyword */
    __$5('field', 'zu-contact'),
    /* translators: block keyword */
    __$5('feedback', 'zu-contact'),
    /* translators: block keyword */
    __$5('form', 'zu-contact')],
    icon: {
      src: field,
      foreground: iconColor
    },
    ...
    example: {
      attributes: {
        id: 'email',
        label: __$5('Email', 'zu-contact'),
        type: 'email',
        required: true,
        placeholder: __$5('Your Email Address', 'zu-contact')
      }
    },
  ...
  var _lodash$9 = lodash,
      isArray = _lodash$9.isArray,
      isNil$3 = _lodash$9.isNil,
      get$3 = _lodash$9.get,
      map$1 = _lodash$9.map,
      transform$2 = _lodash$9.transform,
      includes = _lodash$9.includes,
      omit = _lodash$9.omit,
      omitBy$1 = _lodash$9.omitBy;
  var __$6 = wp.i18n.__; // 'text'+
  ...
  var typeOptions = [{
    value: 'text',
    label: __$6('Text Field', 'zu-contact')
  }, {
    value: 'textarea',
    label: __$6('Message Field', 'zu-contact')
  }, {
    value: 'email',
    label: __$6('E-mail Field', 'zu-contact')
  }, {
    value: 'tel',
    label: __$6('Phone Field', 'zu-contact')
  }, {
    value: 'url',
    label: __$6('URL Field', 'zu-contact')
  }, {
    value: 'checkbox',
    label: __$6('Checkbox Field', 'zu-contact')
  }, {
    value: 'number',
    label: __$6('Number Field', 'zu-contact')
  }, {
    value: 'submit',
    label: __$6('Submit Button Field', 'zu-contact')
  }];
  ...
  var requiredDefaults = omitBy$1(transform$2(fullTypeDefaults, function (values, attr, name) {
    values[name] = (isArray(attr.required) ? get$3(attr, ['required', '0']) : attr.required) || null;
  }), isNil$3);
  var assets$1 = {
  ...
  var _wp$element$3 = wp.element,
      ...
      useCallback$4 = _wp$element$3.useCallback,
      useRef$2 = _wp$element$3.useRef;
  var withSelect$1 = wp.data.withSelect; // Zukit dependencies

  var ModalMessage = wp.zukit.components.ModalMessage; // Internal dependencies

  var submitMessage = __$7('Sorry, but the form submission doesn\'t work in **Edit** mode.\n' + 'To test the form go to [Preview]($link1) mode.', 'zu-contact');
  ...
  var ZuSubmitEdit = function ZuSubmitEdit(_ref) {
    ...
    var spacebarRef = useRef$2(null);
    var submitKeyDown = useCallback$4(function (ev) {
    ...
    var submitClick = useCallback$4(function (ev) {
      var node = String(ev.target.nodeName || ev.target.tagName).toLowerCase();
    ...
    return type !== 'submit' ? null : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
      ...
      value: label,
      attrKey: 'label',
      placeholder: __$7('Add button label...', 'zu-contact'),
      setAttributes: setAttributes
  ...
  var ZuSubmitEdit$1 = compose$1([withSelect$1(function (select) {
    ...
    var label = [getCurrentPostType() === 'page' ? __$7('View Page') : __$7('View Post'), __$7('in new tab')].join(' ');
    return {
  ...
  var _lodash$a = lodash,
      isFunction$1 = _lodash$a.isFunction;
  var __$8 = wp.i18n.__;
  var _wp$components$2 = wp.components,
      ToolbarGroup = _wp$components$2.ToolbarGroup,
      ToolbarButton = _wp$components$2.ToolbarButton,
      Disabled = _wp$components$2.Disabled;
  var BlockControls = wp.blockEditor.BlockControls;
  var useCallback$5 = wp.element.useCallback; // Zukit dependencies
  ...
  var ZuFieldBlockControls = function ZuFieldBlockControls(_ref) {
    ...
    var placeholderLabel = isEditingPlaceholder ? __$8('Submit editing', 'zu-contact') : placeholder$1 ? __$8('Edit placeholder', 'zu-contact') : __$8('Insert placeholder', 'zu-contact');
    var onPlaceholderClick = useCallback$5(function () {
    ...
    var onRequiredClick = useCallback$5(function () {
      return isEditingRequired ? onSubmitRequired() : onEditRequired();
    }, [isEditingRequired, onEditRequired, onSubmitRequired]);
    var requiredLabel = isEditingRequired ? __$8('Submit editing', 'zu-contact') : placeholder$1 ? __$8('Edit error message for the required field', 'zu-contact') : __$8('Insert error message for the required field', 'zu-contact');
    return /*#__PURE__*/React.createElement(BlockControls, null, controls && /*#__PURE__*/React.createElement(ConditionalWrap, {
      ...
      icon: append,
      className: "components-toolbar__control",
      label: __$8('Append field', 'zu-contact'),
      disabled: !isFunction$1(insert),
      onClick: insert
    }), /*#__PURE__*/React.createElement(ToolbarButton, {
      icon: remove,
      className: "components-toolbar__control",
      label: __$8('Remove field', 'zu-contact'),
      disabled: !isFunction$1(remove$1),
      onClick: remove$1
    })));
  };

  // WordPress dependencies
  var forwardRef$1 = wp.element.forwardRef; // Internal dependencies
  var fieldPrefix = 'components-zu-field';
  var inputClass = '__zu-control';
  ...
  var _lodash$b = lodash,
      ...
      has$2 = _lodash$b.has,
      map$2 = _lodash$b.map,
      indexOf = _lodash$b.indexOf,
      noop$1 = _lodash$b.noop;
  var __$9 = wp.i18n.__;
  var compose$2 = wp.compose.compose;
  var _wp$components$3 = wp.components,
      PanelBody$1 = _wp$components$3.PanelBody,
      ToggleControl$1 = _wp$components$3.ToggleControl;
  var createBlock$1 = wp.blocks.createBlock;
  ...
  var _wp$data$3 = wp.data,
      withSelect$2 = _wp$data$3.withSelect,
      withDispatch$1 = _wp$data$3.withDispatch;
  var _wp$element$4 = wp.element,
      useState$2 = _wp$element$4.useState,
      useCallback$6 = _wp$element$4.useCallback,
      useRef$3 = _wp$element$4.useRef,
      useEffect$2 = _wp$element$4.useEffect; // Zukit dependencies

  var _wp$zukit$components$1 = wp.zukit.components,
      SelectItemControl$1 = _wp$zukit$components$1.SelectItemControl,
      AdvTextControl$1 = _wp$zukit$components$1.AdvTextControl; // Internal dependencies
  var fieldPrefix$1 = "".concat(ForwardZuField.fieldPrefix, "__settings");

  var getRequiredValue = function getRequiredValue(type) {
    var prev = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
    var id = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    return get$4(prev, 'requiredValue') || requiredDefaults[id] || requiredDefaults[type];
  };
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    var attributes = _ref.attributes,
        className = _ref.className,
        setAttributes = _ref.setAttributes,
        availableFieldIds = _ref.availableFieldIds,
        remove = _ref.remove,
        insert = _ref.insert;
    ...
    var _useState = useState$2(type === 'checkbox' ? false : ''),
        _useState2 = _slicedToArray(_useState, 2),
        temporaryValue = _useState2[0],
        setTemporaryValue = _useState2[1];

    var attrRef = useRef$3(null);
    var requiredRef = useRef$3(null);
    var inputRef = useRef$3();
    var modeRef = useRef$3({
      required: false,
      invalid: false,
      // not yet implemented!
      placeholder: false
    ...
    var updateField = useFormContext() || noop$1; // create 'text' field as default if no attributes found
    ...
    useEffect$2(function () {
      if (isNil$4(id)) {
        ...
        var uniqueId = uniqueValue(newAttrs.id, availableFieldIds, 'id');

        var newAttrsWithId = _objectSpread2(_objectSpread2({}, newAttrs), {}, {
          id: uniqueId
        });

        setAttributes(newAttrsWithId);
        var requiredValue = getRequiredValue(type);
        setTemporaryRequired(requiredValue);
        updateField({
          type: TYPES.ADD_FIELD,
          id: uniqueId
        }, _objectSpread2(_objectSpread2({}, newAttrsWithId), {}, {
        ...
        updateField({
          type: TYPES.ADD_FIELD,
          id: id // here we use callback with 'prevValue' to merge with data from the store (if any)

        }, function (prevValue) {
          var requiredValue = getRequiredValue(type, prevValue, id);
          setTemporaryRequired(requiredValue);
          return _objectSpread2(_objectSpread2({}, prevValue), {}, {
            id: id,
            type: type,
            required: required,
            requiredValue: requiredValue
    ...
    var onChangeRequired = useCallback$6(function () {
      setAttributes({
        required: !required
      });
      updateField({
    ...
    var onChangeId = useCallback$6(function (newId) {
      setAttributes({
        id: newId
      });
      updateField({
    ...
    var onSubmitRequired = useCallback$6(function () {
      setIsEditingRequired(false);
      updateField({
        type: TYPES.UPDATE_FIELD,
        id: id,
        updated: 'requiredValue'
      }, temporaryRequired); // so that Gutenberg thinks that we have updated the block attributes - call 'setAttributes' with "something"
      // this is needed so that the 'Update' button ceases to be disabled

      setAttributes({
        hack: true
      });
    }, [id, setAttributes, temporaryRequired, updateField]); // Placeholder helpers ----------------------------------------------------]

    var _useState7 = useState$2(false),
        _useState8 = _slicedToArray(_useState7, 2),
        isEditingPlaceholder = _useState8[0],
        setIsEditingPlaceholder = _useState8[1];

    var placeholderEditRef = useRef$3();
    var placeholderEdit = !isEditingPlaceholder ? null : /*#__PURE__*/React.createElement("div", {
      ...
      value: placeholder,
      attrKey: 'placeholder',
      placeholder: __$9('Add field placeholder...', 'zu-contact'),
      setAttributes: setAttributes
    }));
    var onEditPlaceholder = useCallback$6(function () {
    ...
    var selectType = useCallback$6(function (selected) {
      var type = attributes.type,
          id = attributes.id;
      if (selected === type) return; // keep current attributes, maybe they will be used later

      attrRef.current = set$2(attrRef.current || {}, type, attributes); // keep current error message for required, maybe it will be used later

      requiredRef.current = set$2(requiredRef.current || {}, type, temporaryRequired);
      var newAttrs = has$2(attrRef.current, selected) ? attrRef.current[selected] : typeDefaults[selected];
      var newRequired = has$2(requiredRef.current, selected) ? requiredRef.current[selected] : getRequiredValue(selected); // avoid duplicate field id
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls$1, null, /*#__PURE__*/React.createElement(PanelBody$1, {
      className: fieldPrefix$1,
      title: __$9('Field Settings', 'zu-contact')
    }, /*#__PURE__*/React.createElement(SelectItemControl$1, {
      isSmall: true,
      withTooltip: true,
      label: __$9('Field Type', 'zu-contact'),
      ...
      recap: {
        label: __$9('Current Field Type', 'zu-contact'),
        style: {
          color: iconColor
        }
      }
    }), type !== 'submit' && /*#__PURE__*/React.createElement(ToggleControl$1, {
      label: __$9('This is a required field.', 'zu-contact'),
      checked: !!required,
      onChange: onChangeRequired
    }))), /*#__PURE__*/React.createElement(InspectorAdvancedControls$1, null, /*#__PURE__*/React.createElement(AdvTextControl$1, {
      withDebounce: true,
      withoutClear: true,
      label: __$9('Field Id', 'zu-contact'),
      help: __$9('Usually you don\'t need to change it.', 'zu-contact'),
      value: id,
      onChange: onChangeId,
      ...
      remove: remove,
      insert: insert
    })), /*#__PURE__*/React.createElement(ForwardZuField, _extends({
      ref: inputRef,
      labelEdit: labelEdit,
  ...
  var edit$1 = compose$2([withSelect$2(function (select, _ref2) {
    ...
    var availableFieldIds = map$2(fieldIds, function (id) {
      return get$4(getBlockAttributes(id), 'id', null);
    });
    return {
  ...
  }), withDispatch$1(function (dispatch, _ref3) {
    var clientId = _ref3.clientId,
    ...
    return {
      ...
      insert: function insert() {
        return insertBlock(createBlock$1(name$2, {
          type: 'text'
  ...
  var save$1 = function save(_ref) {
    ...
    var id = attributes.id,
        ...
        placeholder = attributes.placeholder,
        rows = attributes.rows;
    return /*#__PURE__*/React.createElement(ForwardZuField, {
      className: className,
      id: id,
      type: type,
      required: required,
  ...
  var settings$1 = _objectSpread2(_objectSpread2({}, metadata$2), {}, {
  ...
  // WordPress dependencies
  var __$a = wp.i18n.__;
  var select$2 = wp.data.select;
  var _wp$element$5 = wp.element,
      useCallback$7 = _wp$element$5.useCallback,
      useState$3 = _wp$element$5.useState; // Zukit dependencies

  var ModalMessage$1 = wp.zukit.components.ModalMessage; // Internal dependencies

  var stubMessage = __$a('This is just a visual emulation of **Google reCAPTCHA**.\n' + 'It doesn\'t work in **Edit** mode. ' + 'To test reCAPTCHA go to [Preview]($link1) mode.', 'zu-contact');

  var ZuRecaptchaStub = function ZuRecaptchaStub(_ref) {
    ...
    var recaptchaClick = useCallback$7(function (ev) {
      setOpen(true);
      ev.preventDefault();
    }, []);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
      ...
      className: "rc-anchor-content"
    }, /*#__PURE__*/React.createElement("div", {
      className: "rc-inline-block"
    }, /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-center-container"
    }, /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-center-item"
    }, /*#__PURE__*/React.createElement("span", {
      className: "recaptcha-checkbox",
      onClick: recaptchaClick
    }, /*#__PURE__*/React.createElement("div", {
    ...
    }, __$a('I\'m not a robot', 'zu-contact'))))), /*#__PURE__*/React.createElement("div", {
      className: isCompact ? 'rc-anchor-compact-footer' : 'rc-anchor-normal-footer'
    }, /*#__PURE__*/React.createElement("div", {
      className: isCompact ? 'rc-anchor-logo-landscape' : 'rc-anchor-logo-portrait'
    }, /*#__PURE__*/React.createElement("div", {
      ...
      className: "rc-anchor-logo-landscape-text-holder"
    }, /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-center-container"
    }, /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-logo-text rc-anchor-center-item"
    }, "reCAPTCHA"))) : /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-logo-text"
    }, "reCAPTCHA")), /*#__PURE__*/React.createElement("div", {
      className: "rc-anchor-pt"
    }, /*#__PURE__*/React.createElement("a", {
      href: "https://www.google.com/intl/".concat(locale, "/policies/privacy/")
    }, __$a('Privacy', 'zu-contact')), /*#__PURE__*/React.createElement("span", {
      "aria-hidden": "true"
    }, " - "), /*#__PURE__*/React.createElement("a", {
      href: "https://www.google.com/intl/".concat(locale, "/policies/terms/")
    }, __$a('Terms', 'zu-contact'))))), /*#__PURE__*/React.createElement(ModalMessage$1, {
      isOpen: isOpen,
      icon: "warning",
      message: stubMessage,
  ...
  var locale = pluginDefaults.locale,
      _pluginDefaults$recap = pluginDefaults.recaptcha.sitekey,
      recaptchaSitekey = _pluginDefaults$recap === void 0 ? '' : _pluginDefaults$recap;

  var ZuRecaptcha = function ZuRecaptcha(_ref2) {
    var withStub = _ref2.withStub,
        size = _ref2.size,
        theme = _ref2.theme;
    return /*#__PURE__*/React.createElement("div", {
      ...
      "data-theme": theme,
      "data-size": size
    }, withStub && /*#__PURE__*/React.createElement(ZuRecaptchaStub, {
  ...
  var _wp$components$4 = wp.components,
      PanelBody$2 = _wp$components$4.PanelBody,
      ToggleControl$2 = _wp$components$4.ToggleControl;
  var InspectorControls$2 = wp.blockEditor.InspectorControls; // const { useState, useCallback, useRef, useEffect } = wp.element;

  var ZuRecaptchaEdit = function ZuRecaptchaEdit(_ref) {
    var attributes = _ref.attributes,
        setAttributes = _ref.setAttributes;
    var theme = attributes.theme,
        size = attributes.size; // Other helpers ----------------------------------------------------------]

    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(InspectorControls$2, null, /*#__PURE__*/React.createElement(PanelBody$2, {
      title: __$b('Settings')
    }, /*#__PURE__*/React.createElement(ToggleControl$2, {
      label: __$b('Use Dark Theme', 'zu-contact'),
      checked: theme === 'dark',
      ...
      label: __$b('Use Compact Widget Size', 'zu-contact'),
      checked: size === 'compact',
      onChange: function onChange(val) {
        return setAttributes({
          size: val ? 'compact' : 'normal'
        });
      }
    }))), /*#__PURE__*/React.createElement(ZuRecaptcha, _extends({
      withStub: true
    }, {
      theme: theme,
      size: size
  ...
  var save$2 = function save(_ref) {
    ...
    return /*#__PURE__*/React.createElement(ZuRecaptcha, {
      theme: theme,
      size: size
    });
  };
  ...
  var settings$2 = _objectSpread2(_objectSpread2({}, metadata), {}, {
    transforms: transforms$2,
    edit: ZuRecaptchaEdit,
    save: save$2
  });

  var recaptcha$2 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    settings: settings$2,
    name: name,
    title: title
  ...
  // WordPress dependencies
  var registerBlockType = wp.blocks.registerBlockType; // Internal dependencies

  var supportsCollections = registerCollection();
  if (!supportsCollections) registerCategory(); //  Register Blocks -----------------------------------------------------------]
  function registerBlocks() {
    [form$1, field$1, recaptcha$2].forEach(function (block) {
      if (!block) return;
      var name = block.name,
