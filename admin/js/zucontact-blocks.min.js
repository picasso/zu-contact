var zucontact_blocks = (function (exports) {
  ...
  function formReducer() {
    ...
    Zubug.data({
      action: action,
      updated: get$1(state, id ? fieldPath : formPath)
    });
    return state;
  }
  ...
  var _wp$element$2 = wp.element,
      ...
      useState = _wp$element$2.useState; // Zukit dependencies
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    ...
    var attrRef = useRef$2(null);
    var requiredRef = useRef$2(null);
    var inputRef = useRef$2();
    var modeRef = useRef$2({
      required: false,
      invalid: false,
      placeholder: false
    ...
    var placeholderEditRef = useRef$2();
