var zucontact_blocks = (function (exports) {
  ...
  var name$1 = 'zu/recaptcha';

  var title = __('ReCAPTCHA v2');
  ...
  var allowedBlocks = [fieldBlock, name$1];
  // 'contact': [
  ...
  var initialState = _defineProperty({}, formsKey, get$1(pluginDefaults, 'store', {}));
  ...
  function formReducer() {
    ...
    switch (type) {
      ...
      case TYPES.REMOVE_FIELD:
        ...
        if (has$1(state, formPath)) state = shallowClone(state, fieldPath);
      ...
      case TYPES.UPDATE_FIELD:
        if (updated === 'type') {
          var newValue = callback(prevValue);
          unset(state, fieldPath);
          set(state, [].concat(_toConsumableArray(pull(fieldPath, id)), [newValue.id]), newValue);
        } else {
          var newField = _objectSpread2(_objectSpread2({}, prevValue), {}, _defineProperty({}, updated, callback(prevValue[updated])));
  ...
  var formActions = {
    updateForm: function updateForm(name, action, value) {
      return _objectSpread2(_objectSpread2({}, isPlainObject(action) ? action : {
        ...
        name: name,
        value: isPlainObject(value) ? pick$1(value, ['id', 'type', 'required', 'requiredValue']) : value
      });
    },
  ...
  var getForms = function getForms() {
    ...
    var forms = isFunction(getForms) ? getForms() : null;
    return name ? get$1(forms, name, null) : forms;
  ...
  var ZuFormEdit = function ZuFormEdit(_ref) {
    ...
    }, [updateForm, setAttributes]); // Title ------------------------------------------------------------------]
  ...
  var edit = compose([withSelect(function (select, _ref2) {
    ...
    var reClientId = reduce(fieldIds, function (reId, id) {
      ...
      return block.name === name$1 ? block.clientId : reId;
    }, null);
    return {
    ...
    return {
      enableRe: function enableRe(val) {
        return val ? insertBlock(createBlock(name$1, _objectSpread2({}, recaptcha$1)), insertIndex, clientId, false) : removeBlock(reClientId, false);
      }
    };
  })])(ZuFormEdit);
  ...
  var metadata$2 = {
    ...
    /* translators: block description */
    description: __$5('Form field of various types and flexible settings.', 'zu-contact'),
    category: 'layout',
    keywords: [
    /* translators: block keyword */
  ...
  var getRequiredValue = function getRequiredValue(type) {
    ...
    return get$4(prev, 'requiredValue') || requiredDefaults[type];
  };
  ...
  var ZuFieldEdit = function ZuFieldEdit(_ref) {
    ...
    var updateField = useFormContext(); // create 'text' field as default if no attributes found
    ...
    useEffect$2(function () {
      if (isNil$4(id)) {
        ...
        updateField({
          ...
          requiredValue: getRequiredValue(newAttrsWithId.type)
        }));
      } else {
        updateField({
          type: TYPES.ADD_FIELD,
          ...
          var requiredValue = getRequiredValue(type, prevValue);
    ...
    var _useState5 = useState$2(getRequiredValue(type)),
  ...
  var edit$1 = compose$2([withSelect$2(function (select, _ref2) {
    ...
    return {
      ...
      insert: function insert() {
        return insertBlock(createBlock$1(name$3, {
          type: 'text'
  ...
  var ZuRecaptchaEdit = function ZuRecaptchaEdit(_ref) {
    ...
    var theme = attributes.theme,
        size = attributes.size; // Sync field changes with information stored on the server ---------------]
    // * * *
    // need to update form store on events:
    // * * *
    // + ADD_FIELD: { id, type, required, requiredValue }
