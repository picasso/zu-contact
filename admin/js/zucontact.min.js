(function () {
	...
	var options = {
	  ...
	  custom_css: {
	    ...
	    help: __('If switched off the plugin stylesheet won\'t be loaded.', 'zu-contact') // depends: 'responsive',
	...
	var recaptcha = {
	  ...
	  themeOptions: [{
	    value: 'light',
	    label: __('Light Theme', 'zu-contact')
	  }, {
	    value: 'dark',
	    label: __('Dark Theme', 'zu-contact')
	  }],
	  sizeOptions: [{
	    value: 'compact',
	    label: __('Compact Widget Size', 'zu-contact')
	  }, {
	    value: 'normal',
	    label: __('Normal Widget Size', 'zu-contact')
	  }],
	...
	var testComponentWithUpdate = wp.zukit.render.testComponentWithUpdate;
	...
	var ZucontactMailer = function ZucontactMailer(_ref) {
	  ...
	  var restore = testComponentWithUpdate('RestoreMailer', updateOptions);
	...
	var testComponentWithUpdate$1 = wp.zukit.render.testComponentWithUpdate;
	var _wp$zukit$components$1 = wp.zukit.components,
	    ...
	    AdvTextControl$1 = _wp$zukit$components$1.AdvTextControl;
	...
	var ZucontactRecaptcha = function ZucontactRecaptcha(_ref) {
	  ...
	  var restore = testComponentWithUpdate$1('RestoreRecaptcha', updateOptions);
	  return /*#__PURE__*/React.createElement(ZukitPanel$1, {
	    ...
	    className: "__flex __right"
	  }, restore, /*#__PURE__*/React.createElement(Button$1, {
	    isSecondary: true,
	    isLarge: true,
	    className: "__plugin_actions __auto magenta",
	    label: data.resetAll,
	...
	var _lodash$2 = lodash,
	    isFunction = _lodash$2.isFunction;
	...
	var EditZucontact = function EditZucontact(_ref) {
	  ...
	  var optionsData = zucontact.options,
	      ...
	      tests = zucontact.tests; // init 'tests' if found
